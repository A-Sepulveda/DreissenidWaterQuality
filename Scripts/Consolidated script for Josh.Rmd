...
packs <- c('readr', 'tidyverse', 'dataRetrieval', 'lubridate', 'mapview')
...
CRB_qw_cleaned = readRDS("D:/Sepulveda_USGS/BOR_mussel_waterquality/DreissenidWaterQuality/Data/raw/CRB_qw_040519.rds")%>%
...
CRB_Laketemp_reduced <- readRDS("D:/Sepulveda_USGS/BOR_mussel_waterquality/DreissenidWaterQuality/Data/raw/CRB_Laketemp_041219.rds") %>% 
...
CRB_Streamtemp_1701 <- readRDS("D:/Sepulveda_USGS/BOR_mussel_waterquality/DreissenidWaterQuality/Data/raw/CRB_Streamtemp_1701.rds") %>%
...
CRB_Streamtemp_1702_04 <- readRDS("D:/Sepulveda_USGS/BOR_mussel_waterquality/DreissenidWaterQuality/Data/raw/CRB_Streamtemp_1702_04 .rds") %>%
  select(OrganizationFormalName,
         ActivityStartDate, ActivityStartTime.Time, ActivityStartTime.TimeZoneCode,
         CharacteristicName,
         MonitoringLocationIdentifier,
...
CRB_Streamtemp_1705 <- readRDS("D:/Sepulveda_USGS/BOR_mussel_waterquality/DreissenidWaterQuality/Data/raw/CRB_Streamtemp_1705.rds") %>% 
  select(OrganizationFormalName,
         ActivityStartDate, ActivityStartTime.Time, ActivityStartTime.TimeZoneCode,
         CharacteristicName,
         MonitoringLocationIdentifier,
...
CRB_Streamtemp_170601 <- readRDS("D:/Sepulveda_USGS/BOR_mussel_waterquality/DreissenidWaterQuality/Data/raw/CRB_Streamtemp_170601.rds") %>% 
  select(OrganizationFormalName,
         ActivityStartDate, ActivityStartTime.Time, ActivityStartTime.TimeZoneCode,
         CharacteristicName,
         MonitoringLocationIdentifier,
...
CRB_Streamtemp_170602 <- readRDS("D:/Sepulveda_USGS/BOR_mussel_waterquality/DreissenidWaterQuality/Data/raw/CRB_Streamtemp_170602.rds") %>% select(OrganizationFormalName,
         ActivityStartDate, ActivityStartTime.Time, ActivityStartTime.TimeZoneCode,
         CharacteristicName,
         MonitoringLocationIdentifier,
         SampleCollectionMethod.MethodName, SampleCollectionEquipmentName,
...
CRB_Streamtemp_170603 <- readRDS("D:/Sepulveda_USGS/BOR_mussel_waterquality/DreissenidWaterQuality/Data/raw/CRB_Streamtemp_170603.rds") %>% select(OrganizationFormalName,
         ActivityStartDate, ActivityStartTime.Time, ActivityStartTime.TimeZoneCode,
         CharacteristicName,
         MonitoringLocationIdentifier,
         SampleCollectionMethod.MethodName, SampleCollectionEquipmentName,
...
CRB_Streamtemp_1707 <- readRDS("D:/Sepulveda_USGS/BOR_mussel_waterquality/DreissenidWaterQuality/Data/raw/CRB_Streamtemp_1707.rds") %>% 
  select(OrganizationFormalName,
         ActivityStartDate, ActivityStartTime.Time, ActivityStartTime.TimeZoneCode,
         CharacteristicName,
         MonitoringLocationIdentifier,
...
CRB_Streamtemp_1708 <- readRDS("D:/Sepulveda_USGS/BOR_mussel_waterquality/DreissenidWaterQuality/Data/raw/CRB_Streamtemp_1708.rds") %>% 
  select(OrganizationFormalName,
         ActivityStartDate, ActivityStartTime.Time, ActivityStartTime.TimeZoneCode,
         CharacteristicName,
         MonitoringLocationIdentifier,
