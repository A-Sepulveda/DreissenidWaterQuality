...
setwd("D:/Sepulveda_USGS/BOR_mussel_waterquality/R scripts")
...
```{r echo=T, results='hide'}
#To load already saved data
CRB_qw = readRDS("CRB_qw_040519.rds") %>% 
...
siteInfo=readRDS("CRB_qw_040519_siteInfo.rds")
...
Time to explore the calcium data
```{r}
CRB_Ca = CRB_qw %>% 
